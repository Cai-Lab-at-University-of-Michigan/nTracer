 ...
 */
public class BufferedHDF5Stack extends VirtualStack implements PlugIn {
    protected List<FileInfo> info;

    /* Default constructor. */
    public BufferedHDF5Stack() {
    ...
    public BufferedHDF5Stack(FileInfo fi) {
        this.processor_fifo = new LinkedList<>();
        this.processor_buffer = new HashMap<>();
        this.info = new ArrayList<>();
    ...
    public BufferedHDF5Stack(FileInfo fi, boolean show) {
        this.processor_fifo = new LinkedList<>();
        this.processor_buffer = new HashMap<>();
        this.info = new ArrayList<>();
    ...
    public static ImagePlus openVirtual(String path) {
        ...
        BufferedHDF5Stack stack = new BufferedHDF5Stack();
        stack.init(dir, name);
        if (stack.info == null) {
            return null;
        } else {
