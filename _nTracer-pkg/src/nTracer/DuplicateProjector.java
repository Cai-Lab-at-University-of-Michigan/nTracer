...
public class DuplicateProjector implements PlugIn, TextListener, ItemListener {
    ...
    /**
     * Rotates duplicated part of image - impA is original image, - roiA is orig
     * rotatedRect - impB contains duplicated overlapping bounding rectangle
     * processing steps: - increase canvas of impB before rotation - rotate impB
     * - calculate excentricity - translate to compensate excentricity - create
     * orthogonal rectangle in center - crop to impC Author: N. Vischer
     */
    ...
    /**
     * Returns a copy of the image, stack or hyperstack contained in the
     * specified ImagePlus.
     *
    ...
    /**
     * Returns a new hyperstack containing a possibly reduced version of the
     * input image.
     */
	...
	* Author Marcel Boeglin 2013.12.15
    ...
    /**
     * This plugin performs a z-projection of the input stack. Type of output
     * image is same as type of input image.
     *
    ...
    private class ZProjector implements PlugIn {
        ...
        /**
         * Performs projection on the entire stack using the specified method
         * and returns the result, where 'method' is "avg", "min", "max", "sum",
         * "sd" or "median". Add " all" to 'method' to project all hyperstack
         * time points.
         */
        ...
        /**
         * Performs projection using the specified method and stack range, and
         * returns the result, where 'method' is "avg", "min", "max", "sum",
         * "sd" or "median". Add " all" to 'method' to project all hyperstack
         * time points. <br>
        ...
        /**
         * Explicitly set image to be projected. This is useful if ZProjection_
         * object is to be used not as a plugin but as a stand alone processing
         * object.
         */
         ...
         * adds stack overlay elements from startSlice to stopSlice to
         * projection.
         */
        ...
        /**
         * Handles mechanics of projection by selecting appropriate pixel array
         * type. We do this rather than using more general ImageProcessor
         * getPixelValue() and putPixel() methods because direct manipulation of
         * pixel arrays is much more efficient.
         */
         ...
         * Preprocessing should be done in derived class constructors.
         */
        abstract class RayFunction {
            ...
            /**
             * Perform any necessary post processing operations, e.g. averging
             * values.
             */
        ...
        class AverageIntensity extends RayFunction {
            ...
            /**
             * Constructor requires number of slices to be projected. This is
             * used to determine average at each pixel.
             */
