 ...
 */
public class ContrastTool2 extends PlugInDialog implements Runnable,
    ...
    Thread thread;
    private ContrastTool2 instance;
    ...
    public ContrastTool2( ImagePlus imp_in ) {
        super("B&C");
        imp = imp_in;
    }
    ...
    public void run(String arg) {
        ...
        instance = this;
        IJ.register(ContrastTool2.class);
